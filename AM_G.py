...
def AM_G(params, ns):
    """
    Exponential growth after split

    T1: Time of split
    nu10: size of pop 1 after split 
    nu20: size of pop 2 after split 
    m12: Migration from pop 2 to pop 1 (2*Na*m12)
    m21: Migration from pop 1 to pop 2
    T2: time when migration ends
    nu1: size of pop 1 after T2
    nu2: size of pop 2 after T2
...
for i in range(1,6):
    ...
    Optimize_Functions.Optimize_Routine(data, prefix, "AM_G", AM_G, 5, 10, data_folded=True, param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)