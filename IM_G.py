...
def IM_G(params, ns):
    """
    Isolation with migration model and exponential growth
...
for i in range(1,6):
    ...
    Optimize_Functions.Optimize_Routine(data, prefix, "IM_G", IM_G, 5, 10, data_folded=True, param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)