...
def SC_NeC(params, ns):
    """
    Secondary contact model with instantaneous Ne changes
    ...
    m12: proportion of pop 2 made up of migrants from pop 1
    m21: proportion of pop 1 made up of migrants from pop 1
    """
...
for i in range(1,6):
    ...
    Optimize_Functions.Optimize_Routine(data, prefix, "SC_NeC", SC_NeC, 4, 8, data_folded=True, param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)