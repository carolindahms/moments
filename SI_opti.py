...
for i in range(1,6):
    ...
    Optimize_Functions.Optimize_Routine(data, prefix, "SI", SI, 3, 3, data_folded=True, param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)
