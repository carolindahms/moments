...
def IM_NeC(params, ns):
    """
    Isolation with migration model with instantaneous Ne changes
...
for i in range(1,6):
    ...
    Optimize_Functions.Optimize_Routine(data, prefix, "IM_NeC", IM_NeC, 4, 8, data_folded=True, param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)     